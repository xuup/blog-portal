...
<script type="text/javascript">
		...
		$.ajax({
			...
			success:function(res){
				...
				for(i=0;i<res.length;i++){
					console.log(i);
					if(i==0){
						beforehtml = "<a href='javascript:void(0)' target='_blank' class='iu' style='font-size:38px;'></a>";
						className = 'zaiyao';
						className1 = 'mecc_tool';
					}else{
						beforehtml = '';
						className = 'zuiyao';
						className1 = 'mucc';
					...
					"<div class="+className1+">"+beforehtml+
					"<img src='" + res[i].picUrl + "' class='wx_img'></img>"+
					"</div></section> "
	...
	function initPageNumber(){
		...
		var page = new Paging();
		page.init({	target: $('#pageTool'), pagesize: maxNum, count: total/6, current:1,callback: function (pagecount, size, count) {
